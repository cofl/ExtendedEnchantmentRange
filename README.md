...
To facilitate this, the enchantment menu now performs a bread-first search from the bookshelf toward the enchanting
table -- this may cause some lag if the values are very high!
